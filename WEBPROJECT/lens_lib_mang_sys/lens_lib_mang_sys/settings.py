"""
Django settings for lens_lib_mang_sys project.
...
SECRET_KEY = 'django-insecure-orlq%+_zizywqpum4hxs9vwds9(e1z7v#t_lfsu#n-qd6$fj$3'
...
ROOT_URLCONF = 'lens_lib_mang_sys.urls'
...
WSGI_APPLICATION = 'lens_lib_mang_sys.wsgi.application'
